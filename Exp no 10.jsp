...
<table>
<tbody>
<tr><th>CustomerID</th><th>CustomerName</th><th>OrderDate</th></tr>
<c:forEach items="${requestScope.cusList}" var="cus">
<tr><td><c:out value="${cus.orderid}"></c:out></td>
<td><c:out value="${cus.customername}"></c:out></td>
<td><c:out value="${cus.orderdate}"></c:out></td></tr>
</c:forEach>
</tbody>
</table>
<br><br>
